...
ANY = lambda v: True
NUMBER = lambda v: v.isdigit and int(v) >= 0
NON_ZORE_NUMBER = lambda v: v.isdigit and int(v) > 0
N_NOT_ZORE = object()
N_IS_ZORE = object()
...
_STATE_MAP = {
    ...
    (STATES.D, (NON_ZORE_NUMBER,)): STATES.E,
...
if __name__ == '__main__':
    ...
    server = TCPServer((host, port), RedisHandler)
